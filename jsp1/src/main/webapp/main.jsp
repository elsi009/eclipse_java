...
<script>
	// main.jsp페이지를 열면 처음에 로그인하기 버튼과 회원가입 버튼 두개만 보여야한다.
...
%>
		...
		let joinForm = document.getElementById("signUp");
...
<div id="signUp">
	<h2>너의 마음에 가입</h2>
	<form method="post" action="signUp.jsp"><br>
	아이디 : <input type="text" name = "id" placehorder="아이디를입력하세요"><br>
